...
class Zoho_Flow_WordPress_org extends Zoho_Flow_Service
{
	...
	public static function  get_userinfo_meta($request){
	    error_log('get userinfo meta');
	    $id = $request['user_id'];
	...
	private function update_meta_values($request, $user_id, $userdata) {
	    error_log('updating meta values');
	    $dataarr = array();
