...
class Zoho_Flow_Contact_Form_7 extends Zoho_Flow_Service
{
    ...
    public function get_fields( $request ) {
        ...
        foreach ( $form_tags as $form_tag ) {
            ...
            if($basetype != 'text' && $basetype != 'email' && $basetype != 'url' && $basetype != 'tel' && $basetype != 'textarea' && $basetype != 'number' && $basetype != 'date' && $basetype != 'select' && $basetype != 'checkbox' && $basetype != 'radio' && $basetype != 'acceptance'&& $basetype != 'file' && $basetype != 'hidden'){
                continue;
            }
