...
<script>
var wpmtesturl = "<?php echo get_bloginfo('url') . '/';?>";
			...
			<form action="" method="post">
				...
				<div class="wpappninja_div">
						...
						<div style="background:#f5f5f5;border:1px solid #eee;padding:20px;max-width:500px;" class="wpapp_admin_w100">
							<div style="float:left;margin-left:35px;"><img src="<?php echo $app_logo;?>" style="width:128px;height:128px;border-radius:15px;background:<?php echo $app_ios_background;?>" /></div>
...
<div class="wpappninja-builder">
	...
	<div class="wpappninja-builder-right">
					...
					<br/>
					<div style="background:#fdfdfd;border:1px solid #eee;padding:20px;max-width:500px;" class="wpapp_admin_w100">
						<div style="float:left;margin-left:35px;"><img class="wpapp_logo_place" src="<?php echo $app_logo;?>" style="width:128px;height:128px;border-radius:35px;background:<?php echo $app_ios_background;?>" id="wpapp_back_logo" /></div>
						<div style="clear:both"></div>
					</div>
