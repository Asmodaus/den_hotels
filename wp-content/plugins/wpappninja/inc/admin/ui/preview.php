...
function _wpappninja_display_preview_page() {
	...
	if (!$homepage_wpapp || $homepage_wpapp == "") {
		...
		$homepage_wpapp = get_bloginfo('url') . '/';
		if (get_wpappninja_option('speed') == '1') {
			$homepage_wpapp = wpappninja_get_home();
		}
	}
...
jQuery('.wpappiframesplash').css('display', 'block');jQuery('.wpappiframeapp').css('display', 'none');setTimeout(function(){jQuery('.wpappiframesplash').css('display', 'none');jQuery('.wpappiframeapp').css('display', 'block');}, 900);
	...
	<div class="wrap">
		...
		$array = array('name'=>$name, 'url'=>get_bloginfo('url') . '/', 'img'=>$logo);
...
<a href="https://apps.apple.com/app/id1555022678" target="_blank"><img style="max-width: 85%;height: auto;" src="https://cdn.wpmobile.app/wp-content/uploads/2016/05/appstoreen.png" alt="appstore" width="284" height="84" /></a><br/><a href="https://play.google.com/store/apps/details?id=demo.wpapp" target="_blank"><img style="max-width: 85%;height: auto;" src="https://cdn.wpmobile.app/wp-content/uploads/2016/05/en_badge_web_generic.png" alt="fr_badge_web_generic" width="282" height="84" /></a>
			...
			<?php
   if (!isset($app_data['logo'])) {$app_data['logo'] = "";}
