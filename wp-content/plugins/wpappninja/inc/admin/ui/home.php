...
if (!isset($app['splashscreen']) OR $app['splashscreen'] == "" OR preg_match('#/wpappninja/assets/images/os/empty\.png$#', $app['splashscreen'])) {$app['splashscreen'] = $app['logo'];}
...
<iframe style="width: 600px;
    ...
    box-shadow: 0 0 2px #eee;" src="https://wpmobile.app/?rand=<?php echo uniqid();?>&hash=<?php echo $hash;?>&v=<?php echo WPAPPNINJA_VERSION;?>&lang=<?php echo $langiframe; ?>&from_wp_website=<?php echo urlencode(get_bloginfo('url') . '/');?>"></iframe>
        </div>
