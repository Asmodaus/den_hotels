...
#wpappninja_app_store_data{max-width:100%!important;}
	...
	<div class="wrap">
		...
		if (1<0) {
			...
			$app_url_home = isset($app_data['url']['home']) ? esc_url($app_data['url']['home']) : get_bloginfo('url')  . '/';
			$app_url_contact = isset($app_data['url']['contact']) ? esc_url($app_data['url']['contact']) : get_bloginfo('url') . '/';
			$app_url_privacy = isset($app_data['url']['privacy']) ? esc_url($app_data['url']['privacy']) : get_bloginfo('url') . '/';
		...
		<div class="wpappninja_banner_click">
			...
			<div id="wpappninja_i__debug" class="wpappninja_i_">
				...
				<div class="wpappninja_div">
					...
					<table class="form-table">
						<tr valign="top">
							<th scope="row"><?php _e('Package name', 'wpappninja');?><?php echo '<br/><a href="https://wpmobile.app/getPackageAndroid.php?url='.urlencode(get_bloginfo('url') . '/').'" target="_blank">'.__('Get it', 'wpappninja').'</a>';?></th>
					...
					<table class="form-table">
						<tr valign="top">
							...
							<?php echo '<br/><a href="https://wpmobile.app/getAppStoreId.php?url='.urlencode(get_bloginfo('url') . '/').'" target="_blank">'.__('Get it', 'wpappninja').'</a>';?></th>
...
">'.get_wpappninja_option('pageashometitle_'.$current_locale, 'Recent post').'<br/></b><br/><a href="' . wpappninja_get_home("speed") . '" target="_blank">' . wpappninja_get_home("speed") . '</a>';
        ...
        $files = array (
  0 => WPAPPNINJA_SVG_PATH . 'add.svg',
  1 => WPAPPNINJA_SVG_PATH . 'add_round.svg',
  2 => WPAPPNINJA_SVG_PATH . 'add_round_fill.svg',
  3 => WPAPPNINJA_SVG_PATH . 'alarm.svg',
  4 => WPAPPNINJA_SVG_PATH . 'alarm_fill.svg',
  5 => WPAPPNINJA_SVG_PATH . 'albums.svg',
  6 => WPAPPNINJA_SVG_PATH . 'albums_fill.svg',
  7 => WPAPPNINJA_SVG_PATH . 'alert.svg',
  8 => WPAPPNINJA_SVG_PATH . 'alert_fill.svg',
  9 => WPAPPNINJA_SVG_PATH . 'arrow.svg',
  10 => WPAPPNINJA_SVG_PATH . 'arrow_down.svg',
  11 => WPAPPNINJA_SVG_PATH . 'arrow_down_fill.svg',
  12 => WPAPPNINJA_SVG_PATH . 'arrow_down_round_fill.svg',
  13 => WPAPPNINJA_SVG_PATH . 'arrow_left.svg',
  14 => WPAPPNINJA_SVG_PATH . 'arrow_left_fill.svg',
  15 => WPAPPNINJA_SVG_PATH . 'arrow_left_round_fill.svg',
  16 => WPAPPNINJA_SVG_PATH . 'arrow_right.svg',
  17 => WPAPPNINJA_SVG_PATH . 'arrow_right_fill.svg',
  18 => WPAPPNINJA_SVG_PATH . 'arrow_right_round_fill.svg',
  19 => WPAPPNINJA_SVG_PATH . 'arrow_up.svg',
  20 => WPAPPNINJA_SVG_PATH . 'arrow_up_fill.svg',
  21 => WPAPPNINJA_SVG_PATH . 'arrow_up_round_fill.svg',
  22 => WPAPPNINJA_SVG_PATH . 'arrowlight.svg',
  23 => WPAPPNINJA_SVG_PATH . 'at.svg',
  24 => WPAPPNINJA_SVG_PATH . 'at_fill.svg',
  25 => WPAPPNINJA_SVG_PATH . 'at_round.svg',
  26 => WPAPPNINJA_SVG_PATH . 'at_round_fill.svg',
  27 => WPAPPNINJA_SVG_PATH . 'attachment.svg',
  28 => WPAPPNINJA_SVG_PATH . 'bag.svg',
  29 => WPAPPNINJA_SVG_PATH . 'bag_fill.svg',
  30 => WPAPPNINJA_SVG_PATH . 'barcode.svg',
  31 => WPAPPNINJA_SVG_PATH . 'barcode_fill.svg',
  32 => WPAPPNINJA_SVG_PATH . 'bars.svg',
  33 => WPAPPNINJA_SVG_PATH . 'bars_chart.svg',
  34 => WPAPPNINJA_SVG_PATH . 'bars_chart_round.svg',
  35 => WPAPPNINJA_SVG_PATH . 'bars_chart_round_fill.svg',
  36 => WPAPPNINJA_SVG_PATH . 'bars_chart_square.svg',
  37 => WPAPPNINJA_SVG_PATH . 'bars_chart_square_fill.svg',
  38 => WPAPPNINJA_SVG_PATH . 'bell.svg',
  39 => WPAPPNINJA_SVG_PATH . 'bell_fill.svg',
  40 => WPAPPNINJA_SVG_PATH . 'bell_off.svg',
  41 => WPAPPNINJA_SVG_PATH . 'bitcoin.svg',
  42 => WPAPPNINJA_SVG_PATH . 'bitcoin_round.svg',
  43 => WPAPPNINJA_SVG_PATH . 'bitcoin_round_fill.svg',
  44 => WPAPPNINJA_SVG_PATH . 'bolt.svg',
  45 => WPAPPNINJA_SVG_PATH . 'bolt_fill.svg',
  46 => WPAPPNINJA_SVG_PATH . 'bolt_round.svg',
  47 => WPAPPNINJA_SVG_PATH . 'bolt_round_fill.svg',
  48 => WPAPPNINJA_SVG_PATH . 'book.svg',
  49 => WPAPPNINJA_SVG_PATH . 'book_fill.svg',
  50 => WPAPPNINJA_SVG_PATH . 'bookmark.svg',
  51 => WPAPPNINJA_SVG_PATH . 'bookmark_fill.svg',
  52 => WPAPPNINJA_SVG_PATH . 'box.svg',
  53 => WPAPPNINJA_SVG_PATH . 'box_fill.svg',
  54 => WPAPPNINJA_SVG_PATH . 'briefcase.svg',
  55 => WPAPPNINJA_SVG_PATH . 'briefcase_fill.svg',
  56 => WPAPPNINJA_SVG_PATH . 'bulb.svg',
  57 => WPAPPNINJA_SVG_PATH . 'bulb_fill.svg',
  58 => WPAPPNINJA_SVG_PATH . 'business.svg',
  59 => WPAPPNINJA_SVG_PATH . 'business_fill.svg',
  60 => WPAPPNINJA_SVG_PATH . 'calendar.svg',
  61 => WPAPPNINJA_SVG_PATH . 'calendar_fill.svg',
  62 => WPAPPNINJA_SVG_PATH . 'calendar_today.svg',
  63 => WPAPPNINJA_SVG_PATH . 'calendar_today_fill.svg',
  64 => WPAPPNINJA_SVG_PATH . 'camera.svg',
  65 => WPAPPNINJA_SVG_PATH . 'camera_fill.svg',
  66 => WPAPPNINJA_SVG_PATH . 'camera_round.svg',
  67 => WPAPPNINJA_SVG_PATH . 'camera_round_fill.svg',
  68 => WPAPPNINJA_SVG_PATH . 'card.svg',
  69 => WPAPPNINJA_SVG_PATH . 'card_fill.svg',
  70 => WPAPPNINJA_SVG_PATH . 'chat.svg',
  71 => WPAPPNINJA_SVG_PATH . 'chat_bubble.svg',
  72 => WPAPPNINJA_SVG_PATH . 'chat_bubble_fill.svg',
  73 => WPAPPNINJA_SVG_PATH . 'chat_fill.svg',
  74 => WPAPPNINJA_SVG_PATH . 'chats.svg',
  75 => WPAPPNINJA_SVG_PATH . 'chats_fill.svg',
  76 => WPAPPNINJA_SVG_PATH . 'check.svg',
  77 => WPAPPNINJA_SVG_PATH . 'check_round.svg',
  78 => WPAPPNINJA_SVG_PATH . 'check_round_fill.svg',
  79 => WPAPPNINJA_SVG_PATH . 'chevron_down.svg',
  80 => WPAPPNINJA_SVG_PATH . 'chevron_down_round.svg',
  81 => WPAPPNINJA_SVG_PATH . 'chevron_down_round_fill.svg',
  82 => WPAPPNINJA_SVG_PATH . 'chevron_left.svg',
  83 => WPAPPNINJA_SVG_PATH . 'chevron_left_round.svg',
  84 => WPAPPNINJA_SVG_PATH . 'chevron_left_round_fill.svg',
  85 => WPAPPNINJA_SVG_PATH . 'chevron_right.svg',
  86 => WPAPPNINJA_SVG_PATH . 'chevron_right_round.svg',
  87 => WPAPPNINJA_SVG_PATH . 'chevron_right_round_fill.svg',
  88 => WPAPPNINJA_SVG_PATH . 'chevron_up.svg',
  89 => WPAPPNINJA_SVG_PATH . 'chevron_up_round.svg',
  90 => WPAPPNINJA_SVG_PATH . 'chevron_up_round_fill.svg',
  91 => WPAPPNINJA_SVG_PATH . 'circle.svg',
  92 => WPAPPNINJA_SVG_PATH . 'circle_fill.svg',
  93 => WPAPPNINJA_SVG_PATH . 'circle_half.svg',
  94 => WPAPPNINJA_SVG_PATH . 'close.svg',
  95 => WPAPPNINJA_SVG_PATH . 'close_round.svg',
  96 => WPAPPNINJA_SVG_PATH . 'close_round_fill.svg',
  97 => WPAPPNINJA_SVG_PATH . 'cloud.svg',
  98 => WPAPPNINJA_SVG_PATH . 'cloud_download.svg',
  99 => WPAPPNINJA_SVG_PATH . 'cloud_download_fill.svg',
  100 => WPAPPNINJA_SVG_PATH . 'cloud_fill.svg',
  101 => WPAPPNINJA_SVG_PATH . 'cloud_upload.svg',
  102 => WPAPPNINJA_SVG_PATH . 'cloud_upload_fill.svg',
  103 => WPAPPNINJA_SVG_PATH . 'collection.svg',
  104 => WPAPPNINJA_SVG_PATH . 'collection_fill.svg',
  105 => WPAPPNINJA_SVG_PATH . 'color_filter.svg',
  106 => WPAPPNINJA_SVG_PATH . 'color_filter_fill.svg',
  107 => WPAPPNINJA_SVG_PATH . 'compass.svg',
  108 => WPAPPNINJA_SVG_PATH . 'compass_fill.svg',
  109 => WPAPPNINJA_SVG_PATH . 'compose.svg',
  110 => WPAPPNINJA_SVG_PATH . 'compose_fill.svg',
  111 => WPAPPNINJA_SVG_PATH . 'data.svg',
  112 => WPAPPNINJA_SVG_PATH . 'data_fill.svg',
  113 => WPAPPNINJA_SVG_PATH . 'delete.svg',
  114 => WPAPPNINJA_SVG_PATH . 'delete_round.svg',
  115 => WPAPPNINJA_SVG_PATH . 'delete_round_fill.svg',
  116 => WPAPPNINJA_SVG_PATH . 'desktop.svg',
  117 => WPAPPNINJA_SVG_PATH . 'document.svg',
  118 => WPAPPNINJA_SVG_PATH . 'document_chart.svg',
  119 => WPAPPNINJA_SVG_PATH . 'document_chart_fill.svg',
  120 => WPAPPNINJA_SVG_PATH . 'document_check.svg',
  121 => WPAPPNINJA_SVG_PATH . 'document_check_fill.svg',
  122 => WPAPPNINJA_SVG_PATH . 'document_fill.svg',
  123 => WPAPPNINJA_SVG_PATH . 'document_person.svg',
  124 => WPAPPNINJA_SVG_PATH . 'document_person_fill.svg',
  125 => WPAPPNINJA_SVG_PATH . 'document_text.svg',
  126 => WPAPPNINJA_SVG_PATH . 'document_text_fill.svg',
  127 => WPAPPNINJA_SVG_PATH . 'down.svg',
  128 => WPAPPNINJA_SVG_PATH . 'download.svg',
  129 => WPAPPNINJA_SVG_PATH . 'download_fill.svg',
  130 => WPAPPNINJA_SVG_PATH . 'download_round.svg',
  131 => WPAPPNINJA_SVG_PATH . 'download_round_fill.svg',
  132 => WPAPPNINJA_SVG_PATH . 'drawer.svg',
  133 => WPAPPNINJA_SVG_PATH . 'drawer_fill.svg',
  134 => WPAPPNINJA_SVG_PATH . 'drawers.svg',
  135 => WPAPPNINJA_SVG_PATH . 'drawers_fill.svg',
  136 => WPAPPNINJA_SVG_PATH . 'edit.svg',
  137 => WPAPPNINJA_SVG_PATH . 'email.svg',
  138 => WPAPPNINJA_SVG_PATH . 'email_fill.svg',
  139 => WPAPPNINJA_SVG_PATH . 'enter.svg',
  140 => WPAPPNINJA_SVG_PATH . 'enter_fill.svg',
  141 => WPAPPNINJA_SVG_PATH . 'enter_round.svg',
  142 => WPAPPNINJA_SVG_PATH . 'enter_round_fill.svg',
  143 => WPAPPNINJA_SVG_PATH . 'exit.svg',
  144 => WPAPPNINJA_SVG_PATH . 'exit_fill.svg',
  145 => WPAPPNINJA_SVG_PATH . 'exit_round.svg',
  146 => WPAPPNINJA_SVG_PATH . 'exit_round_fill.svg',
  147 => WPAPPNINJA_SVG_PATH . 'eye.svg',
  148 => WPAPPNINJA_SVG_PATH . 'eye_fill.svg',
  149 => WPAPPNINJA_SVG_PATH . 'eye_off.svg',
  150 => WPAPPNINJA_SVG_PATH . 'fastforward.svg',
  151 => WPAPPNINJA_SVG_PATH . 'fastforward_fill.svg',
  152 => WPAPPNINJA_SVG_PATH . 'fastforward_round.svg',
  153 => WPAPPNINJA_SVG_PATH . 'fastforward_round_fill.svg',
  154 => WPAPPNINJA_SVG_PATH . 'favorites.svg',
  155 => WPAPPNINJA_SVG_PATH . 'favorites_alt.svg',
  156 => WPAPPNINJA_SVG_PATH . 'favorites_alt_fill.svg',
  157 => WPAPPNINJA_SVG_PATH . 'favorites_fill.svg',
  158 => WPAPPNINJA_SVG_PATH . 'film.svg',
  159 => WPAPPNINJA_SVG_PATH . 'film_fill.svg',
  160 => WPAPPNINJA_SVG_PATH . 'filter-fill.svg',
  161 => WPAPPNINJA_SVG_PATH . 'filter.svg',
  162 => WPAPPNINJA_SVG_PATH . 'fire.svg',
  163 => WPAPPNINJA_SVG_PATH . 'fire_fill.svg',
  164 => WPAPPNINJA_SVG_PATH . 'flag.svg',
  165 => WPAPPNINJA_SVG_PATH . 'flag_fill.svg',
  166 => WPAPPNINJA_SVG_PATH . 'folder.svg',
  167 => WPAPPNINJA_SVG_PATH . 'folder_fill.svg',
  168 => WPAPPNINJA_SVG_PATH . 'forward.svg',
  169 => WPAPPNINJA_SVG_PATH . 'forward_fill.svg',
  170 => WPAPPNINJA_SVG_PATH . 'gear.svg',
  171 => WPAPPNINJA_SVG_PATH . 'gear_fill.svg',
  172 => WPAPPNINJA_SVG_PATH . 'gift.svg',
  173 => WPAPPNINJA_SVG_PATH . 'gift_fill.svg',
  174 => WPAPPNINJA_SVG_PATH . 'graph_round.svg',
  175 => WPAPPNINJA_SVG_PATH . 'graph_round_fill.svg',
  176 => WPAPPNINJA_SVG_PATH . 'graph_square.svg',
  177 => WPAPPNINJA_SVG_PATH . 'graph_square_fill.svg',
  178 => WPAPPNINJA_SVG_PATH . 'hand.svg',
  179 => WPAPPNINJA_SVG_PATH . 'hand_alt.svg',
  180 => WPAPPNINJA_SVG_PATH . 'heart.svg',
  181 => WPAPPNINJA_SVG_PATH . 'heart_fill.svg',
  182 => WPAPPNINJA_SVG_PATH . 'help.svg',
  183 => WPAPPNINJA_SVG_PATH . 'help_fill.svg',
  184 => WPAPPNINJA_SVG_PATH . 'help_round.svg',
  185 => WPAPPNINJA_SVG_PATH . 'help_round_fill.svg',
  186 => WPAPPNINJA_SVG_PATH . 'home.svg',
  187 => WPAPPNINJA_SVG_PATH . 'home_fill.svg',
  188 => WPAPPNINJA_SVG_PATH . 'images.svg',
  189 => WPAPPNINJA_SVG_PATH . 'images_fill.svg',
  190 => WPAPPNINJA_SVG_PATH . 'infinite.svg',
  191 => WPAPPNINJA_SVG_PATH . 'info.svg',
  192 => WPAPPNINJA_SVG_PATH . 'info_fill.svg',
  193 => WPAPPNINJA_SVG_PATH . 'info_round.svg',
  194 => WPAPPNINJA_SVG_PATH . 'info_round_fill.svg',
  195 => WPAPPNINJA_SVG_PATH . 'keyboard.svg',
  196 => WPAPPNINJA_SVG_PATH . 'keyboard_fill.svg',
  197 => WPAPPNINJA_SVG_PATH . 'laptop.svg',
  198 => WPAPPNINJA_SVG_PATH . 'layers.svg',
  199 => WPAPPNINJA_SVG_PATH . 'layers_alt.svg',
  200 => WPAPPNINJA_SVG_PATH . 'layers_alt_fill.svg',
  201 => WPAPPNINJA_SVG_PATH . 'layers_fill.svg',
  202 => WPAPPNINJA_SVG_PATH . 'left.svg',
  203 => WPAPPNINJA_SVG_PATH . 'library.svg',
  204 => WPAPPNINJA_SVG_PATH . 'library_fill.svg',
  205 => WPAPPNINJA_SVG_PATH . 'link.svg',
  206 => WPAPPNINJA_SVG_PATH . 'list.svg',
  207 => WPAPPNINJA_SVG_PATH . 'list_fill.svg',
  208 => WPAPPNINJA_SVG_PATH . 'lock.svg',
  209 => WPAPPNINJA_SVG_PATH . 'lock_fill.svg',
  210 => WPAPPNINJA_SVG_PATH . 'login.svg',
  211 => WPAPPNINJA_SVG_PATH . 'login_fill.svg',
  212 => WPAPPNINJA_SVG_PATH . 'logo_android.svg',
  213 => WPAPPNINJA_SVG_PATH . 'logo_android_text.svg',
  214 => WPAPPNINJA_SVG_PATH . 'logo_apple.svg',
  215 => WPAPPNINJA_SVG_PATH . 'logo_facebook.svg',
  216 => WPAPPNINJA_SVG_PATH . 'logo_github.svg',
  217 => WPAPPNINJA_SVG_PATH . 'logo_google.svg',
  218 => WPAPPNINJA_SVG_PATH . 'logo_google_text.svg',
  219 => WPAPPNINJA_SVG_PATH . 'logo_googleplus.svg',
  220 => WPAPPNINJA_SVG_PATH . 'logo_instagram.svg',
  221 => WPAPPNINJA_SVG_PATH . 'logo_ios.svg',
  222 => WPAPPNINJA_SVG_PATH . 'logo_linkedin.svg',
  223 => WPAPPNINJA_SVG_PATH . 'logo_macos.svg',
  224 => WPAPPNINJA_SVG_PATH . 'logo_microsoft.svg',
  225 => WPAPPNINJA_SVG_PATH . 'logo_rss.svg',
  226 => WPAPPNINJA_SVG_PATH . 'logo_twitter.svg',
  227 => WPAPPNINJA_SVG_PATH . 'logo_windows.svg',
  228 => WPAPPNINJA_SVG_PATH . 'logout.svg',
  229 => WPAPPNINJA_SVG_PATH . 'logout_fill.svg',
  230 => WPAPPNINJA_SVG_PATH . 'menu.svg',
  231 => WPAPPNINJA_SVG_PATH . 'message.svg',
  232 => WPAPPNINJA_SVG_PATH . 'message_fill.svg',
  233 => WPAPPNINJA_SVG_PATH . 'mic.svg',
  234 => WPAPPNINJA_SVG_PATH . 'mic_fill.svg',
  235 => WPAPPNINJA_SVG_PATH . 'mic_off.svg',
  236 => WPAPPNINJA_SVG_PATH . 'mic_round.svg',
  237 => WPAPPNINJA_SVG_PATH . 'mic_round_fill.svg',
  238 => WPAPPNINJA_SVG_PATH . 'money_dollar.svg',
  239 => WPAPPNINJA_SVG_PATH . 'money_dollar_fill.svg',
  240 => WPAPPNINJA_SVG_PATH . 'money_dollar_round.svg',
  241 => WPAPPNINJA_SVG_PATH . 'money_dollar_round_fill.svg',
  242 => WPAPPNINJA_SVG_PATH . 'money_euro.svg',
  243 => WPAPPNINJA_SVG_PATH . 'money_euro_fill.svg',
  244 => WPAPPNINJA_SVG_PATH . 'money_euro_round.svg',
  245 => WPAPPNINJA_SVG_PATH . 'money_euro_round_fill.svg',
  246 => WPAPPNINJA_SVG_PATH . 'money_pound.svg',
  247 => WPAPPNINJA_SVG_PATH . 'money_pound_fill.svg',
  248 => WPAPPNINJA_SVG_PATH . 'money_pound_round.svg',
  249 => WPAPPNINJA_SVG_PATH . 'money_pound_round_fill.svg',
  250 => WPAPPNINJA_SVG_PATH . 'money_rubl.svg',
  251 => WPAPPNINJA_SVG_PATH . 'money_rubl_fill.svg',
  252 => WPAPPNINJA_SVG_PATH . 'money_rubl_round.svg',
  253 => WPAPPNINJA_SVG_PATH . 'money_rubl_round_fill.svg',
  254 => WPAPPNINJA_SVG_PATH . 'money_yen.svg',
  255 => WPAPPNINJA_SVG_PATH . 'money_yen_fill.svg',
  256 => WPAPPNINJA_SVG_PATH . 'money_yen_round.svg',
  257 => WPAPPNINJA_SVG_PATH . 'money_yen_round_fill.svg',
  258 => WPAPPNINJA_SVG_PATH . 'more.svg',
  259 => WPAPPNINJA_SVG_PATH . 'more_fill.svg',
  260 => WPAPPNINJA_SVG_PATH . 'more_round.svg',
  261 => WPAPPNINJA_SVG_PATH . 'more_round_fill.svg',
  262 => WPAPPNINJA_SVG_PATH . 'more_vertical.svg',
  263 => WPAPPNINJA_SVG_PATH . 'more_vertical_fill.svg',
  264 => WPAPPNINJA_SVG_PATH . 'more_vertical_round.svg',
  265 => WPAPPNINJA_SVG_PATH . 'more_vertical_round_fill.svg',
  266 => WPAPPNINJA_SVG_PATH . 'navigation.svg',
  267 => WPAPPNINJA_SVG_PATH . 'navigation_fill.svg',
  268 => WPAPPNINJA_SVG_PATH . 'navigation_round.svg',
  269 => WPAPPNINJA_SVG_PATH . 'navigation_round_fill.svg',
  270 => WPAPPNINJA_SVG_PATH . 'paper_plane.svg',
  271 => WPAPPNINJA_SVG_PATH . 'paper_plane_fill.svg',
  272 => WPAPPNINJA_SVG_PATH . 'pause.svg',
  273 => WPAPPNINJA_SVG_PATH . 'pause_fill.svg',
  274 => WPAPPNINJA_SVG_PATH . 'pause_round.svg',
  275 => WPAPPNINJA_SVG_PATH . 'pause_round_fill.svg',
  276 => WPAPPNINJA_SVG_PATH . 'person.svg',
  277 => WPAPPNINJA_SVG_PATH . 'person_fill.svg',
  278 => WPAPPNINJA_SVG_PATH . 'person_round.svg',
  279 => WPAPPNINJA_SVG_PATH . 'person_round_fill.svg',
  280 => WPAPPNINJA_SVG_PATH . 'persons.svg',
  281 => WPAPPNINJA_SVG_PATH . 'persons_fill.svg',
  282 => WPAPPNINJA_SVG_PATH . 'persons_round.svg',
  283 => WPAPPNINJA_SVG_PATH . 'persons_round_fill.svg',
  284 => WPAPPNINJA_SVG_PATH . 'phone.svg',
  285 => WPAPPNINJA_SVG_PATH . 'phone_fill.svg',
  286 => WPAPPNINJA_SVG_PATH . 'phone_landscape.svg',
  287 => WPAPPNINJA_SVG_PATH . 'phone_portrait.svg',
  288 => WPAPPNINJA_SVG_PATH . 'phone_round.svg',
  289 => WPAPPNINJA_SVG_PATH . 'phone_round_fill.svg',
  290 => WPAPPNINJA_SVG_PATH . 'photos.svg',
  291 => WPAPPNINJA_SVG_PATH . 'photos_fill.svg',
  292 => WPAPPNINJA_SVG_PATH . 'pie.svg',
  293 => WPAPPNINJA_SVG_PATH . 'pie_chart.svg',
  294 => WPAPPNINJA_SVG_PATH . 'pie_chart_fill.svg',
  295 => WPAPPNINJA_SVG_PATH . 'pie_fill.svg',
  296 => WPAPPNINJA_SVG_PATH . 'placemark.svg',
  297 => WPAPPNINJA_SVG_PATH . 'placemark_fill.svg',
  298 => WPAPPNINJA_SVG_PATH . 'play.svg',
  299 => WPAPPNINJA_SVG_PATH . 'play_fill.svg',
  300 => WPAPPNINJA_SVG_PATH . 'play_round.svg',
  301 => WPAPPNINJA_SVG_PATH . 'play_round_fill.svg',
  302 => WPAPPNINJA_SVG_PATH . 'qrcode.svg',
  303 => WPAPPNINJA_SVG_PATH . 'radio.svg',
  304 => WPAPPNINJA_SVG_PATH . 'redo.svg',
  305 => WPAPPNINJA_SVG_PATH . 'refresh.svg',
  306 => WPAPPNINJA_SVG_PATH . 'refresh_round.svg',
  307 => WPAPPNINJA_SVG_PATH . 'refresh_round_fill.svg',
  308 => WPAPPNINJA_SVG_PATH . 'reload.svg',
  309 => WPAPPNINJA_SVG_PATH . 'reload_round.svg',
  310 => WPAPPNINJA_SVG_PATH . 'reload_round_fill.svg',
  311 => WPAPPNINJA_SVG_PATH . 'reply.svg',
  312 => WPAPPNINJA_SVG_PATH . 'reply_fill.svg',
  313 => WPAPPNINJA_SVG_PATH . 'rewind.svg',
  314 => WPAPPNINJA_SVG_PATH . 'rewind_fill.svg',
  315 => WPAPPNINJA_SVG_PATH . 'rewind_round.svg',
  316 => WPAPPNINJA_SVG_PATH . 'rewind_round_fill.svg',
  317 => WPAPPNINJA_SVG_PATH . 'right.svg',
  318 => WPAPPNINJA_SVG_PATH . 'rocket.svg',
  319 => WPAPPNINJA_SVG_PATH . 'rocket_fill.svg',
  320 => WPAPPNINJA_SVG_PATH . 'scissors.svg',
  321 => WPAPPNINJA_SVG_PATH . 'search.svg',
  322 => WPAPPNINJA_SVG_PATH . 'search_strong.svg',
  323 => WPAPPNINJA_SVG_PATH . 'settings.svg',
  324 => WPAPPNINJA_SVG_PATH . 'settings_fill.svg',
  325 => WPAPPNINJA_SVG_PATH . 'share.svg',
  326 => WPAPPNINJA_SVG_PATH . 'share_fill.svg',
  327 => WPAPPNINJA_SVG_PATH . 'social_facebook.svg',
  328 => WPAPPNINJA_SVG_PATH . 'social_facebook_fill.svg',
  329 => WPAPPNINJA_SVG_PATH . 'social_github.svg',
  330 => WPAPPNINJA_SVG_PATH . 'social_github_fill.svg',
  331 => WPAPPNINJA_SVG_PATH . 'social_googleplus.svg',
  332 => WPAPPNINJA_SVG_PATH . 'social_instagram.svg',
  333 => WPAPPNINJA_SVG_PATH . 'social_instagram_fill.svg',
  334 => WPAPPNINJA_SVG_PATH . 'social_linkedin.svg',
  335 => WPAPPNINJA_SVG_PATH . 'social_linkedin_fill.svg',
  336 => WPAPPNINJA_SVG_PATH . 'social_rss.svg',
  337 => WPAPPNINJA_SVG_PATH . 'social_rss_fill.svg',
  338 => WPAPPNINJA_SVG_PATH . 'social_twitter.svg',
  339 => WPAPPNINJA_SVG_PATH . 'social_twitter_fill.svg',
  340 => WPAPPNINJA_SVG_PATH . 'sort.svg',
  341 => WPAPPNINJA_SVG_PATH . 'sort_down.svg',
  342 => WPAPPNINJA_SVG_PATH . 'sort_down_round.svg',
  343 => WPAPPNINJA_SVG_PATH . 'sort_down_round_fill.svg',
  344 => WPAPPNINJA_SVG_PATH . 'sort_fill.svg',
  345 => WPAPPNINJA_SVG_PATH . 'sort_round.svg',
  346 => WPAPPNINJA_SVG_PATH . 'sort_round_fill.svg',
  347 => WPAPPNINJA_SVG_PATH . 'sort_up.svg',
  348 => WPAPPNINJA_SVG_PATH . 'sort_up_round.svg',
  349 => WPAPPNINJA_SVG_PATH . 'sort_up_round_fill.svg',
  350 => WPAPPNINJA_SVG_PATH . 'star.svg',
  351 => WPAPPNINJA_SVG_PATH . 'star_fill.svg',
  352 => WPAPPNINJA_SVG_PATH . 'star_half.svg',
  353 => WPAPPNINJA_SVG_PATH . 'star_round_fill.svg',
  354 => WPAPPNINJA_SVG_PATH . 'stopwatch.svg',
  355 => WPAPPNINJA_SVG_PATH . 'stopwatch_fill.svg',
  356 => WPAPPNINJA_SVG_PATH . 'tablet_landscape.svg',
  357 => WPAPPNINJA_SVG_PATH . 'tablet_portrait.svg',
  358 => WPAPPNINJA_SVG_PATH . 'tabs.svg',
  359 => WPAPPNINJA_SVG_PATH . 'tabs_fill.svg',
  360 => WPAPPNINJA_SVG_PATH . 'tag.svg',
  361 => WPAPPNINJA_SVG_PATH . 'tag_fill.svg',
  362 => WPAPPNINJA_SVG_PATH . 'tags.svg',
  363 => WPAPPNINJA_SVG_PATH . 'tags_fill.svg',
  364 => WPAPPNINJA_SVG_PATH . 'tape.svg',
  365 => WPAPPNINJA_SVG_PATH . 'tape_fill.svg',
  366 => WPAPPNINJA_SVG_PATH . 'thumbs_down.svg',
  367 => WPAPPNINJA_SVG_PATH . 'thumbs_up.svg',
  368 => WPAPPNINJA_SVG_PATH . 'ticket.svg',
  369 => WPAPPNINJA_SVG_PATH . 'ticket_fill.svg',
  370 => WPAPPNINJA_SVG_PATH . 'tickets.svg',
  371 => WPAPPNINJA_SVG_PATH . 'tickets_fill.svg',
  372 => WPAPPNINJA_SVG_PATH . 'time.svg',
  373 => WPAPPNINJA_SVG_PATH . 'time_fill.svg',
  374 => WPAPPNINJA_SVG_PATH . 'timer.svg',
  375 => WPAPPNINJA_SVG_PATH . 'timer_fill.svg',
  376 => WPAPPNINJA_SVG_PATH . 'today.svg',
  377 => WPAPPNINJA_SVG_PATH . 'today_fill.svg',
  378 => WPAPPNINJA_SVG_PATH . 'trash.svg',
  379 => WPAPPNINJA_SVG_PATH . 'trash_fill.svg',
  380 => WPAPPNINJA_SVG_PATH . 'tune.svg',
  381 => WPAPPNINJA_SVG_PATH . 'tune_fill.svg',
  382 => WPAPPNINJA_SVG_PATH . 'undo.svg',
  383 => WPAPPNINJA_SVG_PATH . 'unlock.svg',
  384 => WPAPPNINJA_SVG_PATH . 'unlock_fill.svg',
  385 => WPAPPNINJA_SVG_PATH . 'up.svg',
  386 => WPAPPNINJA_SVG_PATH . 'upload_round.svg',
  387 => WPAPPNINJA_SVG_PATH . 'upload_round_fill.svg',
  388 => WPAPPNINJA_SVG_PATH . 'videocam.svg',
  389 => WPAPPNINJA_SVG_PATH . 'videocam_fill.svg',
  390 => WPAPPNINJA_SVG_PATH . 'videocam_round.svg',
  391 => WPAPPNINJA_SVG_PATH . 'videocam_round_fill.svg',
  392 => WPAPPNINJA_SVG_PATH . 'volume.svg',
  393 => WPAPPNINJA_SVG_PATH . 'volume_fill.svg',
  394 => WPAPPNINJA_SVG_PATH . 'volume_low.svg',
  395 => WPAPPNINJA_SVG_PATH . 'volume_low_fill.svg',
  396 => WPAPPNINJA_SVG_PATH . 'volume_mute.svg',
  397 => WPAPPNINJA_SVG_PATH . 'volume_mute_fill.svg',
  398 => WPAPPNINJA_SVG_PATH . 'volume_off.svg',
  399 => WPAPPNINJA_SVG_PATH . 'waterdrop.svg',
  400 => WPAPPNINJA_SVG_PATH . 'waterdrop_fill.svg',
  401 => WPAPPNINJA_SVG_PATH . 'world.svg',
  402 => WPAPPNINJA_SVG_PATH . 'world_fill.svg',
  403 => WPAPPNINJA_SVG_PATH . 'zoom_in.svg',
  404 => WPAPPNINJA_SVG_PATH . 'zoom_out.svg',
);
...
display:none;
  ...
  404 => WPAPPNINJA_SVG_PATH . 'zoom_out.svg',
    ...
    margin: 0 0 15px;" href="#" onclick="jQuery(\'#label_iconic_'.$i.'\').css(\'display\', \'block\');return false">'.__('Change the icon').'</a></div>';
								...
								// item
                                $uniqIdExternal = 'i'.uniqid();
								if ($item['id'] == 'http://separatorend' OR $item['id'] == 'http://separator'){echo '<div style="display:none;">';}
								echo '<br/>
								'.__('URL', 'wpappninja').'<br/>
								<input id="'.$uniqIdExternal.'" style="width: 95%;padding: 10px;font-size: 17px;margin: 0 0 15px;" type="text" name="' . WPAPPNINJA_SLUG . '[menu_reload_'.$current_locale.']['.$i.'][id]" value="'.wpappninja_get_http_link($item).'" /><br/>';
        
                                if (!preg_match('#wpmobileexternal#', wpappninja_get_http_link($item))) {
                                
                                    echo '<span style="cursor: pointer;text-decoration: underline;font-size: 11px;margin-top: -5px;display: block;" onclick="jQuery(\'#'.$uniqIdExternal.'\').each(function() {jQuery(this).attr(\'value\', jQuery(this).attr(\'value\')+\'?wpmobileexternal=true\');});jQuery(this).css(\'display\', \'none\');">'.__('Make this link open in the browser?', 'wpappninja').'</span><br/><br/>';
                                }
...
<div style="clear:both"></div>
			...
			<input type="hidden" name="<?php echo WPAPPNINJA_SLUG;?>[rightpreview]" value="<?php echo get_wpappninja_option('rightpreview', 'manage_options');?>" />
    ...
    if (get_wpappninja_option('speed') == '1') {
    	...
    	array_unshift($results, array(
      	...
      	array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url') ) . "/?wpapp_shortcode=wpapp_recent",
            'info' => 'Recents'
        ));
	    ...
	    array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url') ) . "/?wpapp_shortcode=wpapp_history",
    	...
    	array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url') ) . "/?wpapp_shortcode=wpapp_config",
            'info' => 'Push config'
        ));
    	...
    	array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url')) . "/?wpapp_shortcode=wpapp_home",
    	...
    	array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url') ) . "/?wpapp_shortcode=wpapp_login",
            'info' => 'Login page'
        ));
    	...
    	array_unshift($results, array(
            ...
            'permalink' => preg_replace('#/$#', '', get_bloginfo('url')) . "/?wpmobileshareme",
            'info' => 'Share box'
        ));
